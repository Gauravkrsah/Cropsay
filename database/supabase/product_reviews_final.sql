-- Product Reviews SQL setup for Supabase (Final Version)
-- This file sets up the tables and functions needed for the product review system
-- with proper handling of JSONB format orders.items
...
-- Properly handles JSONB array items in orders table
...
SELECT 
  ...
  -- Using full_name from profiles table instead of username
